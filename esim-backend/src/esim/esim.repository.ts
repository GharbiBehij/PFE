...
import { Prisma, TransactionStatus, EsimStatus } from '@prisma/client';
...
export class EsimRepository {
  ...
  async createAndLinkTransaction(
    data: Prisma.EsimUncheckedCreateInput,
  ...
  updateStatusTx(tx: any, id: number, status: EsimStatus) {
