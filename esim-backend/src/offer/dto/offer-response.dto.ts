...
export class OfferResponseDto {
  ...
  @ApiProperty({
    example: 'Affordable eSIM package for short trips in France.',
  })
  description: string;
  ...
  @ApiProperty({ example: '4G', description: 'Network type: 4G, 4G/5G, or 5G' })
  networkType: string;
...
export class OfferDestinationResponseDto {
  @ApiProperty({ example: 'France' })
  country: string;
  ...
  @ApiProperty({ example: 1800, description: 'Starting price in minor units' })
  price: number;
}
